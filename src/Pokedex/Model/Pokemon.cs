...
public class Pokemon {
	...
	public string LongId { get { return id.ToString().PadLeft(3, '0'); } }
	public bool is_default { get; set; }
	public string location_area_encounters { get; set; }
	public List<Move> moves { get; set; }
	public string name { get; set; }
	public string FullName { get { return System.Globalization.CultureInfo.CurrentCulture.TextInfo.ToTitleCase(name); } }
	...
	public int stat_hp { get { return stats.Where(stat => stat.stat.name == "hp").FirstOrDefault().base_stat; } }
	public int stat_atk { get { return stats.Where(stat => stat.stat.name == "attack").FirstOrDefault().base_stat; } }
	public int stat_def { get { return stats.Where(stat => stat.stat.name == "defense").FirstOrDefault().base_stat; } }
	public int stat_satk { get { return stats.Where(stat => stat.stat.name == "special-attack").FirstOrDefault().base_stat; } }
	public int stat_sdef { get { return stats.Where(stat => stat.stat.name == "special-defense").FirstOrDefault().base_stat; } }
	public int stat_spe { get { return stats.Where(stat => stat.stat.name == "speed").FirstOrDefault().base_stat; } }

	public string stat_hp_str { get { return stats.Where(stat => stat.stat.name == "hp").FirstOrDefault().base_stat.ToString().PadLeft(3, '0'); } }
	public string stat_atk_str { get { return stats.Where(stat => stat.stat.name == "attack").FirstOrDefault().base_stat.ToString().PadLeft(3, '0'); } }
	public string stat_def_str { get { return stats.Where(stat => stat.stat.name == "defense").FirstOrDefault().base_stat.ToString().PadLeft(3, '0'); } }
	public string stat_satk_str { get { return stats.Where(stat => stat.stat.name == "special-attack").FirstOrDefault().base_stat.ToString().PadLeft(3, '0'); } }
	public string stat_sdef_str { get { return stats.Where(stat => stat.stat.name == "special-defense").FirstOrDefault().base_stat.ToString().PadLeft(3, '0'); } }
	public string stat_spe_str { get { return stats.Where(stat => stat.stat.name == "speed").FirstOrDefault().base_stat.ToString().PadLeft(3, '0'); } }
}
